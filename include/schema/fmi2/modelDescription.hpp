...
namespace ssp4cpp::fmi2
{
    ...
    public:
        optional<string> quantity;
        vector<fmi2::SimpleTypeEnumerationItem> item;
    ...
    {
    public:
        vector<fmi2::unknown> Outputs;
        vector<fmi2::unknown> Derivatives;
        vector<fmi2::unknown> InitialUnknowns;
