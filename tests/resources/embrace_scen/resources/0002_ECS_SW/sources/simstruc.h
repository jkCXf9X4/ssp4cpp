...
typedef enum {
    ...
    GEN_FCN_SET_NUM_MODELREF_INTFPARAM_MODEL_ARGS,
    GEN_FCN_REG_MODELREF_INTFPARAM_MODEL_ARG,
    ...
    GEN_FCN_MODELREF_FCNCALL_PORT_GROUP_SET_TASK_PRIORITY,
    GEN_FCN_MODELREF_FCNCALL_PORT_GROUP_SET_TID,
    ...
    GEN_FCN_MODELREF_FCNCALL_PORT_GROUP_SET_HAS_TASK_PRIORITY,
    ...
    GEN_FCN_MODELREF_SET_NUM_EXPLICIT_TASKING_TS,
    ...
    GEN_FCN_MODELREF_SET_PARAMETER_CHANGE_EVENT_TID,
    ...
    GEN_FCN_SET_NUM_MODELREF_INTFPARAM_BLOCK_ARGS,
    GEN_FCN_REG_MODELREF_INTFPARAM_BLOCK_ARG,
...
# define ssSetInputPortComplexSignal(S,port,val) \
 ...
 /* InputUnit - For each input port of your S-function block, this is the
  *   unit. If no unit is specified, then the default is "unitless".
  */
...
/* OutputUnit - For each input port of your S-function block, this is the
  *   unit. If no unit is specified, then the default is "unitless".
  */
...
# define ssSetNumModelRefModelArgs(S, nParams) \
     _ssSafelyCallGenericFcnStart(S)(S, \
GEN_FCN_SET_NUM_MODELREF_INTFPARAM_MODEL_ARGS, nParams, NULL) \
     _ssSafelyCallGenericFcnEnd

# define ssSetNumModelRefBlockArgs(S, nParams) \
     _ssSafelyCallGenericFcnStart(S)(S, \
GEN_FCN_SET_NUM_MODELREF_INTFPARAM_BLOCK_ARGS, nParams, NULL) \
     _ssSafelyCallGenericFcnEnd
...
# define ssRegModelRefModelArg(S, pIdx, id, used, numDims, dimsPtr, cplx, dtId) \
   { \
      _ssModelRefIntfParamInfoInit( \
               id, used, numDims, dimsPtr, cplx, dtId) \
         if (!_ssSafelyCallGenericFcnStart(S)(S, \
GEN_FCN_REG_MODELREF_INTFPARAM_MODEL_ARG, pIdx, &locPI) \
         _ssSafelyCallGenericFcnEnd) return; \
   }

# define ssRegModelRefBlockArg(S, pIdx, id, used, numDims, dimsPtr, cplx, dtId) \
   { \
      _ssModelRefIntfParamInfoInit( \
               id, used, numDims, dimsPtr, cplx, dtId) \
         if (!_ssSafelyCallGenericFcnStart(S)(S, \
GEN_FCN_REG_MODELREF_INTFPARAM_BLOCK_ARG, pIdx, &locPI) \
         _ssSafelyCallGenericFcnEnd) return; \
   }

# define ssRegModelRefStructModelArg(S, pIdx, id, used, numDims, dimsPtr, cplx, dtChecksum, \
...
# define ssRegModelRefStructBlockArg(S, pIdx, id, used, numDims, dimsPtr, cplx, dtChecksum, \
                                     dtName, dtIsAnonymous) \
   { \
      _ssModelRefIntfStructParamInfoInit( \
          id, used, numDims, dimsPtr, cplx, dtChecksum, dtName, dtIsAnonymous) \
...
# define ssRegModelRefScaledDoubleModelArg(S, pIdx, id, used, numDims, dimsPtr, cplx, \
   ...
   { \
     ...
     ssRegModelRefModelArg(S, pIdx, id, used, numDims, dimsPtr, cplx, fixptDTId); \
   }

# define ssRegModelRefScaledDoubleBlockArg(S, pIdx, id, used, numDims, dimsPtr, cplx, \
                          isSigned, nBits, fracSlope, fixSlope, bias, override) \
   { \
     DTypeId fixptDTId = ssRegisterDataTypeFxpScaledDouble(S, \
       isSigned, nBits, (double) fracSlope, fixSlope, (double) bias, override); \
     if (fixptDTId == INVALID_DTYPE_ID) return; \
     ssRegModelRefBlockArg(S, pIdx, id, used, numDims, dimsPtr, cplx, fixptDTId); \
   }

# define ssRegModelRefFixptModelArg(S, pIdx, id, used, numDims, dimsPtr, cplx, \
       isSigned, nBits, fracSlope, fixSlope, bias, override) \
   { \
...
# define ssRegModelRefFixptBlockArg(S, pIdx, id, used, numDims, dimsPtr, cplx, \
       isSigned, nBits, fracSlope, fixSlope, bias, override) \
   { \
     DTypeId fixptDTId = ssRegisterDataTypeFxpFSlopeFixExpBias(S, \
       isSigned, nBits, (double) fracSlope, fixSlope, (double) bias, override); \
...
#define _ssGetBlockPath(S, sysIdx, blkIdx, path)                                \
    {                                                                          \
        BlockPathInfo info;                                                    \
        info.sysIdx = sysIdx;                                                  \
        info.blkIdx = blkIdx;                                                  \
...
#define _ssIsPositiveDataValue(S, data, dtId, result)                          \
    {                                                                          \
        DataQueryInfo info;                                                    \
        info.data = data;                                                      \
        info.dtId = dtId;                                                      \
...
#define _ssSignDataValue(S, data, dtId, result)                                \
    {                                                                          \
        DataQueryInfo info;                                                    \
        info.data = data;                                                      \
        info.dtId = dtId;                                                      \
...
# define ssModelRefFcnCallPortGroupSetHasTaskPriority(S, value) \
 {  boolean_T val = value; \
     _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_MODELREF_FCNCALL_PORT_GROUP_SET_HAS_TASK_PRIORITY, 0, &val) \
    _ssSafelyCallGenericFcnEnd; \
 }

# define ssModelRefFcnCallPortGroupSetTaskPriority(S, value) \
 {  int_T val = value; \
     _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_MODELREF_FCNCALL_PORT_GROUP_SET_TASK_PRIORITY, 0, &val) \
    _ssSafelyCallGenericFcnEnd; \
 }

# define ssModelRefFcnCallPortGroupSetTid(S, value) \
 {  int_T val = value; \
     _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_MODELREF_FCNCALL_PORT_GROUP_SET_TID, 0, &val) \
    _ssSafelyCallGenericFcnEnd; \
 }
...
# define ssSetNumExplicitTaskingTs(S, numExpTaskTs) \
 { \
     _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_MODELREF_SET_NUM_EXPLICIT_TASKING_TS, (numExpTaskTs), NULL) \
     _ssSafelyCallGenericFcnEnd; \
 }

# define ssSetParameterChangeEventTID(S, tid) \
 { \
     _ssSafelyCallGenericFcnStart(S)((S), GEN_FCN_MODELREF_SET_PARAMETER_CHANGE_EVENT_TID, (tid), NULL) \
     _ssSafelyCallGenericFcnEnd; \
 }
